...
proc obj_browser {{pat *} {ns ""}} {
    ...
    set $obj_browse.all_cmds [lsort [uplevel "info commands [set ns]$pat"]]
    set $obj_browse.namespaces [lsort [namespace eval [set ns] namespace children]]
    set $obj_browse.gvars [lsort [info vars [set ns]$pat]]
